...
/-! # `Cross1AssemblyData` bundle for `reducedClass_eq_of_isReduction'_cross1`
...
1. `sa.P1` is no longer a free point in the CA-witness-facing block — it
   is forced to `Point.iota Ra` via `hP1eq`, so `Cross1AssemblyData` has
...
2. `caCrossInterpMatrix`/`caCrossCoeff`/`bCACross`/`uCANewCross`/
   `denomPolyCACross` (three free points `RaX,Ra2X,P2X` plus derivative
...
3. `h1P1,h1P2,h2P1,h2P2,hPP` collapse to the three-hypothesis family
   `h1,h2,h3` (`RaX≠Ra2X`, `RaX≠P2X`, `Ra2X≠P2X`).
4. `hP1_curve`/`hP1Y_ne` are gone (no free `sa.P1` to state them about);
   `hP1Deriv` (the derivative datum's defining equation) replaces them.
...
-- types (uCANewCross/bCACross/caCrossInterpMatrix applications repeated
...
/-- **Construction-specific assembly layer for the cross1
(`sa.P1 = ι(Ra)`) `reducedClass_eq_of_isReduction'_cross1` theorem.**
...
structure Cross1AssemblyData
  ...
  -- docstring's diff): `sa.P1` is NOT a free point here, it is forced to
  ...
  hT1Y_ne : as_T1.Y ≠ 0
  hT2Y_ne : as_T2.Y ≠ 0
  -- **The cross1 `CAWitness` construction (item 2 of the diff)**: three
  -- free points `as_Ra.X,as_Ra2.X,sa.P2.X` plus `vDerivAtP1`, replacing
  -- `caInterpMatrix`/`uCANew`/`bCA`/`denomPolyCA`'s four-free-point forms.
  as_vDerivAtP1 : F p
  hdet : (caCrossInterpMatrix as_Ra.X as_Ra2.X sa.P2.X).det ≠ 0
  hlead : caCrossCoeff as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1 sa.P2.Y 3 ≠ 0
  h1 : as_Ra.X ≠ as_Ra2.X
  h2 : as_Ra.X ≠ sa.P2.X
  h3 : as_Ra2.X ≠ sa.P2.X
  ...
  hP2Y_ne : sa.P2.Y ≠ 0
  hne : H.f - (bCACross as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1 sa.P2.Y) ^ 2 ≠ 0
  hU_evalRa :
      (uCANewCross H as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1
        sa.P2.Y).eval as_Ra.X ≠ 0
  hU_evalRa2 :
      (uCANewCross H as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1
        sa.P2.Y).eval as_Ra2.X ≠ 0
  hU_evalP2 :
      (uCANewCross H as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1
        sa.P2.Y).eval sa.P2.X ≠ 0
  hU_ne0 : uCANewCross H as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1 sa.P2.Y ≠ 0
  as_PtT1 : H.Point
  as_PtT2 : H.Point
  hPtT1X : as_PtT1.X ≠ as_PtT2.X
  hPtT1 :
      (uCANewCross H as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1
        sa.P2.Y).IsRoot as_PtT1.X
  hPtT2 :
      (uCANewCross H as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1
        sa.P2.Y).IsRoot as_PtT2.X
  as_Q1 : Polynomial (F p)
  as_Q2 : Polynomial (F p)
  hQ1_def : uCANewCross H as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1 sa.P2.Y =
      (Polynomial.X - Polynomial.C as_PtT1.X) * (Polynomial.X - Polynomial.C as_PtT2.X) * as_Q1
  hQ1T1 : as_Q1.eval as_PtT1.X ≠ 0
  hQ2_def : uCANewCross H as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1 sa.P2.Y =
      (Polynomial.X - Polynomial.C as_PtT2.X) * (Polynomial.X - Polynomial.C as_PtT1.X) * as_Q2
  hQ2T2 : as_Q2.eval as_PtT2.X ≠ 0
  hAeval1 : (denomPolyCACross as_Ra.X as_Ra2.X sa.P2.X : Polynomial (F p)).eval as_PtT1.X ≠ 0
  hAeval2 : (denomPolyCACross as_Ra.X as_Ra2.X sa.P2.X : Polynomial (F p)).eval as_PtT2.X ≠ 0
  hPtT1Y :
      as_PtT1.Y = (bCACross as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1
        sa.P2.Y).eval as_PtT1.X
  hPtT1Y_ne : as_PtT1.Y ≠ 0
  hPtT2Y :
      as_PtT2.Y = (bCACross as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1
        sa.P2.Y).eval as_PtT2.X
  ...
  hsupp_f : ∀ P, P ∉ ({as_Ra, as_Ra2, Point.iota sa.P2, as_PtT1, as_PtT2} :
      Finset H.Point) →
    ordAt P (-bCACross as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1 sa.P2.Y)
      (1 : Polynomial (F p)) = 0
  hspec_f : ∀ vv : IsDedekindDomain.HeightOneSpectrum (CoordinateRing H),
    (Associates.mk vv.asIdeal).count (Associates.mk (Ideal.span
      ({toPair H (-bCACross as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1 sa.P2.Y) 1} :
        Set (CoordinateRing H)))).factors ≠ 0 → ∃ P, vv.asIdeal = pointIdeal P
  [hspec_f_finite : ∀ P : ({as_Ra, as_Ra2, Point.iota sa.P2, as_PtT1, as_PtT2} : Finset H.Point),
    Module.Finite (F p) (CoordinateRing H ⧸ pointIdeal P.1 ^
      (ordAt P.1 (-bCACross as_Ra.X as_Ra2.X sa.P2.X as_Ra.Y as_Ra2.Y as_vDerivAtP1 sa.P2.Y)
...
-- Bumped for the same reason as Cross1AssemblyData above: the proof
-- body threads ~90 hypothesis/field references through several
-- multi-argument callee applications (cAmιTmδmιδ_mem_of_le_cross1 alone
...
set_option maxHeartbeats 1000000 in
/-- **Cross1 theorem, bundled.** Mirrors `ReducedClassBundles.lean`'s
bundled base theorem, taking `(base : ReductionData sa) (d :
Cross1AssemblyData sa)` instead of the ~90-hypothesis flat signature.
Proof body is `AlphaLocusDegreeUniformCross1.lean`'s original proof with
every free variable replaced by its `d.`-projection, `hP1eq` handled
identically via `d.hP1eq` at the same point in the argument. -/
theorem reducedClass_eq_of_isReduction'_cross1 {p : ℕ} [Fact (Nat.Prime p)] [Fact (p ≠ 2)]
    {H : HyperellipticPolynomial (F p)} [IsDedekindDomain (CoordinateRing H)]
    [DecidableEq H.Point]
    {D : PrincipalDivisorData H}
    {aClass : Jacobian H D} {δ₀ : H.Point}
  ...
  have hDP := cAmιTmδmιδ_mem_of_le_cross1 (H := H) hdeg d.hchar d.hsf D hD
    d.hspec_linX
    d.as_Ra.X d.as_Ra2.X sa.P2.X d.as_Ra.Y d.as_Ra2.Y d.as_vDerivAtP1 sa.P2.Y
    d.hdet d.hlead d.h1 d.h2 d.h3
    d.hRa_curve d.hRa2_curve d.hP2_curve d.hP1Deriv d.hRaY_ne d.hRa2Y_ne d.hP2Y_ne
    d.as_Ra d.as_Ra2 sa.P2 (Point.iota sa.P2)
    rfl rfl rfl rfl rfl rfl rfl rfl
    d.hne
    d.hU_evalRa d.hU_evalRa2 d.hU_evalP2 d.hU_ne0
    ...
    d.hRaT1 d.hRaT2 d.hRa2T1 d.hRa2T2 d.hP2T1 d.hP2T2
  ...
  have hcoe : ((aAnchor - aP1P2Nι : Divisor0 H) : Divisor H) -
      ...
      (single d.as_Ra + single d.as_Ra2 - single sa.P1 - single sa.P2 -
