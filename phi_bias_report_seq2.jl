# =============================================================================
#  phi_bias_report_seq2.jl  --  Seq 2: LP1-conj temporal analysis.
#
#  Seq 2 covers: Fano factor, CIR (conditional intensity ratio),
#  Welch PSD, spectrogram, Allan factor, New 1-5, and key fingerprint.
#
#  Called from _report_seq2!; not intended to be called directly.
# =============================================================================

using FFTW   # rfft / plan_rfft used in Welch PSD and multitaper sections

# ---------------------------------------------------------------------------
#  _report_seq2! — Seq 2 full block.
#  stat     : PhiBiasStat
